const brewers = [
  {
    ...
    portrait: "assets/james-hoffmann.jpg",
    recipes: [
  ...
  },
  {
    ...
    portrait: "assets/tetsu-kasuya.jpg",
    recipes: [
  ...
  },
  {
    ...
    portrait: "assets/lance-hedrick.jpg",
    recipes: [
  ...
  },
  {
    ...
    portrait: "assets/matt-winton.png",
    recipes: [
  ...
  },
  {
    ...
    portrait: "assets/patrik-rolf.jpg",
    recipes: [
...
brewers.forEach((brewer, brewerIndex) => {
  ...
  card.innerHTML = `
    <header class="recipe-card-header">
      <div class="brewer-portrait-wrap">
        <img class="brewer-portrait" src="${brewer.portrait}" alt="Portrait of ${brewer.name}" loading="lazy">
